package com.apkfuns.androidcalendar;
...
import com.apkfuns.androidcalendar.manager.Day;
import com.apkfuns.androidcalendar.manager.Formatter;
import com.apkfuns.androidcalendar.manager.Month;
import com.apkfuns.androidcalendar.manager.ResizeManager;
import com.apkfuns.androidcalendar.manager.Week;
import com.apkfuns.androidcalendar.widget.DayView;
import com.apkfuns.androidcalendar.widget.WeekView;
...
public class CalendarView extends LinearLayout implements View.OnClickListener {
    ...
    public CalendarView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            showToolBar = typedArray.getBoolean(R.styleable.CalendarView_showToolBar, true);
        }
    ...
    public interface OnMonthChangeListener {
        void onMonthChange(boolean prevMonth, LocalDate month);
    }
